...
#             max_memory={0: "5GB", 'cpu': "16GB"},#delete
#             low_cpu_mem_usage=True#delete 
#         )#.to(device)
...
# Setup the page layout to be wide
st.set_page_config(layout="wide")

# Create two columns for the layout
chat_col, preview_col = st.columns([0.5, 0.5])
...
# Preview and controls in the right column
with preview_col:
    st.title("Presentation Preview")
    
    # Download and Clean Up buttons at the top
    if st.session_state.get("generated", False):
